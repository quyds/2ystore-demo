								...
								<div class="col-12">
					                <div class="breadcrumbs">
										<ul>
									        ...
									        <li>
										        <a href="${base }/nike/women"><span> Nữ</span></a>
										        <meta>
									        </li>
										</ul>
									</div>
								</div>
								<c:forEach items="${nikeWomen.data}" var="nikeWomen" begin="0" end="23">
								<div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 col-6 itemPro">
									<div class="ps-shoe mb-30">
										<div class="ps-shoe_thumbnail">
											...
											<a class="ps-shoe_overlay" href="${base }/product/details/${nikeWomen.seo}"><img src="${base }/Upload/${nikeWomen.avatar}"></a>
										</div>
										<div class="ps-shoe_content">
											<div class="ps-shoe_detail">
												<a class="ps-shoe_name" href="${base }/product/details/${nikeWomen.seo}">${nikeWomen.title}</a>
												...
												<span class="ps-shoe_price">
													...
													<fmt:formatNumber value="${nikeWomen.price }" type="currency" />
												</span>
											</div>
										</div>
									</div>

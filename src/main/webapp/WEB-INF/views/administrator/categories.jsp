                        ...
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="active">
                                ...
                                <ul class="collapse">
                                    ...
                                    <li><a href="${base }/admin/add-categories">Thêm danh mục</a></li>
                                </ul>
                            </li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true">
                                            ...
                                            <div class="table-responsive" style="overflow-x: unset;">
	                                            <form action="${base }/admin/categories"  method="get">
	                                            	<div class="d-flex flex-row justify-content-between mt-4">
														...
														<div>
															<a class="btn btn-outline-primary mb-1" href="${base }/admin/add-categories" role="button">Add New</a>
														</div>
													</div>
	                                                <table class="table text-center">
	                                                    ...
	                                                    <tbody>
	                                                  	    <c:forEach items="${categories.data}" var="cate">
	                                                        <tr>
	                                                            ...
	                                                            <td>
	                                                                <a href="${base }/admin/add-categories/${cate.id}">
	                                                                	<i class="ti-pencil-alt" style="color: blue; font-size: 18px;"></i>
	                                                                </a>
	                                                               <a href="">
	                                                                	<i class="ti-trash" style="color: red; font-size: 18px;"></i>
	                                                               </a>
	                                                            </td>
	                                                        </tr>
	                                                        </c:forEach>

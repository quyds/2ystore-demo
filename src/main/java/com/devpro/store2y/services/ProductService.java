...
//				sql += " and p.status=1 ";
	...
	public Product add(Product p, MultipartFile productAvatar, MultipartFile[] productPictures)
		...
		if (!isEmptyUploadFile(productAvatar)) {
			...
			String pathToFile = "E:/Devpro/Backend/Upload/product/avatar/" + productAvatar.getOriginalFilename();
		...
		if (!isEmptyUploadFile(productPictures)) {
			...
			for (MultipartFile pic : productPictures) {
				...
				pic.transferTo(new File("E:/Devpro/Backend/Upload/product/pictures/" + pic.getOriginalFilename()));
	...
	public Product update(Product p, MultipartFile productAvatar, MultipartFile[] productPictures)
		...
		if (!isEmptyUploadFile(productAvatar)) {
			...
			new File("E:/Devpro/Backend/Upload/" + productInDb.getAvatar()).delete();

			// add avartar moi
			productAvatar.transferTo(new File("E:/Devpro/Backend/Upload/product/avatar/" + productAvatar.getOriginalFilename()));
			p.setAvatar("product/avatar/" + productAvatar.getOriginalFilename());
		} 
		else {
